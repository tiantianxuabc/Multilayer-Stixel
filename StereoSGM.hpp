...
inline void swapPointers(uint16*& p1, uint16*& p2)/*0000*/
{
	uint16* temp = p1;
	p1 = p2;
	p2 = temp;
...
inline sint32 adaptP2(const float32& alpha, const uint16& I_p, const uint16& I_pr, const int& gamma, const int& P2min)/*0000*/
{
	sint32 result;
